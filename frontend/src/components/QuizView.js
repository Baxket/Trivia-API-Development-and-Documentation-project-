...
class QuizView extends Component {
  ...
  getNextQuestion = () => {
    ...
    $.ajax({
      ...
      crossDomain: true,
      success: (result) => {
        /*if total questions is less than the default question per play
        then update the questions per play to its total to give you the final score else play to the 
        5th question
*/
